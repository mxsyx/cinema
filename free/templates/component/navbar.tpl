...
<nav class="navbar" role="navigation">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand nav-item visible-xs" href="/" title="搜索">搜索</a>
    </div><!-- /.navbar-header -->  
    <!-- 导航条主体 -->
    <div id="navbar-body" class="collapse navbar-collapse">
      ...
      <div class="navbar-form navbar-right hidden-xs">
        <div class="form-group">
          <input type="text" class="form-control" placeholder="输入影片名"><input id="submit"
            src="/static/images/icon/sou.svg" align="absmiddle" type="image">
        </div>
      </div>
    </div><!-- /.navbar-body -->  
  </div><!-- /.container -->  
